...
class PostTest(TestCase):
    def setUp(self):
        ...
        user = User.objects.create_user(email='admin1337@admin.com', password='1')
        posts = [
            Post(title='first_post', author=user),
            Post(title='second_post', author=user),
            Post(title='third_post', author=user)
        ]
    ...
    def test_list(self):
        ...
        assert response.data['results'][0]['title'] == 'first_post'
    ...
    def test_retrieve(self):
        ...
        assert response.data['title'] == 'first_post'

    
    def test_auth(self):
        data = {
            'title':'new new new new'
        }
